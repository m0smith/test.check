...
(defn ustring
  ...
  ( [num-elements]  (fmap clojure.string/join (vector uchar num-elements)))
  ( [min-elements max-elements]  (fmap clojure.string/join (vector uchar min-elements max-elements))))
